...
<body class="rece">
    <header>
        <menu>
            <div class="recei"><img src="./img/receitas/Receitas.png" alt="">
            </div>
            <div class="logo">
        ...
        <div class="todos-videos">
            <div class="video-card">
                <div class="video-content">
                    ...
                    <img src="./img/videoimg/CafeCremosoComChocolate.png">
                    <h2>INGREDIENTES:</h2>
            ...
            <div class="trailer">
                ...
                <img src="./img/videoimg/close.png" class="close-receita" onclick="toggle();">
            </div>
            <div class="video-card">
                <div class="video-content">
                    <h1>FRAPPUCCINO</h1>
                    <img src="./img/videoimg/frapuccino.png">
                    <h2>INGREDIENTES:</h2>
                    <p>250ml de Café</p>
                    <p>250ml de Leite</p>
            ...
            <div class="video-card">
                <div class="video-content">
                    ...
                    <img src="./img/videoimg/CafeGelado Com Leite.png">
                    <h2>INGREDIENTES:</h2>
                    <p>250ml de Café</p>
                    <p>50ml de LEITE</p>
