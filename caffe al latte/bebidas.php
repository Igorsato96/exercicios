...
<body class="bebidas">
    <div class="popup-bebidas">
        <header>
            <menu>
                <div class="bebida"><img src="./img/bebidas cardapio bg.png" alt="">
                </div>
                <div class="logo">
            ...
            <section>
                <div class="product-cardp">
                    <div class="product-card">
                        ...
                        <div class="product-pic"><img src="./img/bebidas/expresso.png"></div>
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-expresso" id="popup-expresso">
                                        <div class="popup-inner">
                                            ...
                                            <img src="./img/bebidas/expresso.png">
                                            </div>
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-pic"><img src="./img/bebidas/americano.png"></div>
                        <div class="product-colors1">
                        </div>
                        <div class="product-info2">
                            <div class="product-price">R$ 4,50</div>
                            <div class="botao">
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-cafe" id="popup-cafe">
                                        <div class="popup-inner">
                                            <div class="popup-photo">
                                            <img src="./img/bebidas/americano.png">
                                            </div>
                                            <div class="popup-text">
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-pic"><img src="./img/bebidas/latte.png"></div>
                        <div class="product-colors1">
                        </div>
                        <div class="product-info2">
                            <div class="product-price">R$ 4,50</div>
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-pic"><img src="./img/bebidas/capuccino.png"></div>
                        <div class="product-colors1">
                        </div>
                        <div class="product-info2">
                            <div class="product-price">R$ 4,50</div>
                            <div class="botao">
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-capuccino" id="popup-capuccino">
                                        <div class="popup-inner">
                                            <div class="popup-photo">
                                            <img src="./img/bebidas/capuccino.png">
                                            </div>
                                            <div class="popup-text">
                                                <h1>CAPUCCINO</h1>
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium odio consectetur pariatur corrupti exercitationem tempore, voluptate dolore itaque incidunt explicabo quae expedita et ad neque! Laboriosam
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-colors">
                            <span class="limao active" data-text="cha limao" data-text2="Cha de limao e delicios" data-pic="url(img/bebidas/chalimao.png)"></span>
                            <span class="pessego" data-text="cha pessego" data-pic="url(img/bebidas/chapessego.png)"></span>
                            <span class="matcha" data-text="matcha" data-pic="url(img/bebidas/matcha.png)"></span>
                            <span class="sakura" data-text="cha sakura" data-pic="url(img/bebidas/chasakura.png)"></span>
                        </div>
                            ...
                            <div class="botao">
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-cha" id="popup-cha">
                                        <div class="popup-inner">
                                            <div class="popup-photo">
                                                <img src="./img/bebidas/chalimao.png">
                                            </div>
                                            <div class="popup-text">
                                                <h1>Chá</h1>
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium odio consectetur pariatur corrupti exercitationem tempore, voluptate dolore itaque incidunt explicabo quae expedita et ad neque! Laboriosam
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-pic"><img src="./img/bebidas/chocolate quente.png"></div>
                        <div class="product-colors1">
                        </div>
                        <div class="product-info2">
                            <div class="product-price">R$ 4,50</div>
                            <div class="botao">
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-quente" id="popup-quente">
                                        <div class="popup-inner">
                                            <div class="popup-photo">
                                            <img src="./img/bebidas/chocolate quente.png">
                                            </div>
                                            <div class="popup-text">
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-pic"><img src="./img/bebidas/moccha.png"></div>
                        <div class="product-colors1">
                        </div>
                        <div class="product-info2">
                            <div class="product-price">R$ 4,50</div>
                            <div class="botao">
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-moccha" id="popup-moccha">
                                        <div class="popup-inner">
                                            <div class="popup-photo">
                                            <img src="./img/bebidas/moccha.png">
                                            </div>
                                            <div class="popup-text">
                                                <h1>MOCCHA</h1>
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium odio consectetur pariatur corrupti exercitationem tempore, voluptate dolore itaque incidunt explicabo quae expedita et ad neque! Laboriosam
                    ...
                    <div class="product-card">
                        ...
                        <div class="product-colors-milk">
                            <span class="chocolate active" data-text1="MILKSHAKE CHOCOLATE" data-pic1="url(img/bebidas/milkchoco.png)"></span>
                            <span class="morango" data-text1="MILKSHAKE MORANGO" data-pic1="url(img/bebidas/milkmora.png)"></span>
                            <span class="baunilha" data-text1="MILKSHAKE BAUNILHA" data-pic1="url(img/bebidas/milkbau.png)"></span>
                        </div>
                        <div class="product-info2">
                            <div class="product-price">R$ 4,50</div>
                            <div class="botao">
                                ...
                                <div id="saiba-mais">
                                    ...
                                    <div class="popup-milkshake" id="popup-milkshake">
                                        <div class="popup-inner">
                                            <div class="popup-photo">
                                                <img src="./img/bebidas/milkchoco.png">
                                            </div>
                                            <div class="popup-text">
                                                <h1>MILKSHAKE</h1>
                                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Praesentium odio consectetur pariatur corrupti exercitationem tempore, voluptate dolore itaque incidunt explicabo quae expedita et ad neque! Laboriosam
